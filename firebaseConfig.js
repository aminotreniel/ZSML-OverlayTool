    ...
    if (cleaned.draftdata) {
        ...
        if (cleaned.draftdata.blueside) {
            if (cleaned.draftdata.blueside.ban) {
                cleaned.draftdata.blueside.ban = cleaned.draftdata.blueside.ban.map(cleanHeroData);
            }
            if (cleaned.draftdata.blueside.pick) {
                cleaned.draftdata.blueside.pick = cleaned.draftdata.blueside.pick.map(cleanHeroData);
            }
        }
        ...
        if (cleaned.draftdata.redside) {
            if (cleaned.draftdata.redside.ban) {
                cleaned.draftdata.redside.ban = cleaned.draftdata.redside.ban.map(cleanHeroData);
            }
            if (cleaned.draftdata.redside.pick) {
                cleaned.draftdata.redside.pick = cleaned.draftdata.redside.pick.map(cleanHeroData);
            }
        }
    }
